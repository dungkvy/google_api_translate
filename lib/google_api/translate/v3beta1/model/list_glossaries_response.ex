...
defmodule GoogleApi.Translate.V3beta1.Model.ListGlossariesResponse do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Translate.V3beta1.Model.ListGlossariesResponse do
  def decode(value, options) do
    GoogleApi.Translate.V3beta1.Model.ListGlossariesResponse.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Translate.V3beta1.Model.ListGlossariesResponse do
