...
defmodule GoogleApi.Translate.V3beta1.Model.Operation do
  @moduledoc """
  ...
  *   `done` (*type:* `boolean()`, *default:* `nil`) - If the value is `false`, it means the operation is still in progress.
      ...
      available.
  *   `error` (*type:* `GoogleApi.Translate.V3beta1.Model.Status.t`, *default:* `nil`) - The error result of the operation in case of failure or cancellation.
...
defimpl Poison.Decoder, for: GoogleApi.Translate.V3beta1.Model.Operation do
  def decode(value, options) do
    GoogleApi.Translate.V3beta1.Model.Operation.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Translate.V3beta1.Model.Operation do
