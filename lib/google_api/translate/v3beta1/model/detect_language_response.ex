...
defmodule GoogleApi.Translate.V3beta1.Model.DetectLanguageResponse do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Translate.V3beta1.Model.DetectLanguageResponse do
  def decode(value, options) do
    GoogleApi.Translate.V3beta1.Model.DetectLanguageResponse.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Translate.V3beta1.Model.DetectLanguageResponse do
