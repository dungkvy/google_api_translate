...
defmodule GoogleApi.Translate.V3beta1.Model.GcsDestination do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Translate.V3beta1.Model.GcsDestination do
  def decode(value, options) do
    GoogleApi.Translate.V3beta1.Model.GcsDestination.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Translate.V3beta1.Model.GcsDestination do
