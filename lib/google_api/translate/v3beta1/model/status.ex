...
defmodule GoogleApi.Translate.V3beta1.Model.Status do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Translate.V3beta1.Model.Status do
  def decode(value, options) do
    GoogleApi.Translate.V3beta1.Model.Status.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Translate.V3beta1.Model.Status do
