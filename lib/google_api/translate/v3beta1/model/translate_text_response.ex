...
defmodule GoogleApi.Translate.V3beta1.Model.TranslateTextResponse do
  ...
  *   `glossaryTranslations` (*type:* `list(GoogleApi.Translate.V3beta1.Model.Translation.t)`, *default:* `nil`) - Text translation responses if a glossary is provided in the request.
      ...
      `contents`.
  *   `translations` (*type:* `list(GoogleApi.Translate.V3beta1.Model.Translation.t)`, *default:* `nil`) - Text translation responses with no glossary applied.
      This field has the same length as
      `contents`.
  """
...
defimpl Poison.Decoder, for: GoogleApi.Translate.V3beta1.Model.TranslateTextResponse do
  def decode(value, options) do
    GoogleApi.Translate.V3beta1.Model.TranslateTextResponse.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Translate.V3beta1.Model.TranslateTextResponse do
