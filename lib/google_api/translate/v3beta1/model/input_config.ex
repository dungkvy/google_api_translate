...
defmodule GoogleApi.Translate.V3beta1.Model.InputConfig do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Translate.V3beta1.Model.InputConfig do
  def decode(value, options) do
    GoogleApi.Translate.V3beta1.Model.InputConfig.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Translate.V3beta1.Model.InputConfig do
