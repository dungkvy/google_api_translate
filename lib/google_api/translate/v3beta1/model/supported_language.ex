...
defmodule GoogleApi.Translate.V3beta1.Model.SupportedLanguage do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Translate.V3beta1.Model.SupportedLanguage do
  def decode(value, options) do
    GoogleApi.Translate.V3beta1.Model.SupportedLanguage.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Translate.V3beta1.Model.SupportedLanguage do
